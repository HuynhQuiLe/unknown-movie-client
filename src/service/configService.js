...
export const MOVIES_BASE_URL = " http://localhost:6868/movies";

export const COMMENT_BASE_URL = " http://localhost:6868/comments";

export const THEATER_BASE_URL = "http://localhost:6868/theaters";

export const BRANCH_BASE_URL = "http://localhost:6868/branches";

export const SCHEDULE_IN_TOTAL_BASE_URL =
  "http://localhost:6868/schedulesInTotal";
